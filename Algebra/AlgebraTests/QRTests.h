...
namespace AlgebraTests
{
	inline int QRTests()
	{
...

		{
			...
			cout << testMatrix << endl << "Computing QR decomposition..." << endl;
			Matrix<double> Q(3, 3);
			Matrix<double> R(3, 3);
			int status = QR(testMatrix, Q, R);
			cout << "R = " << endl << R << endl << "Q = " << Q << endl;
			Matrix<double> QR = Q * R;
			cout << "QR = " << endl << QR << endl;
		}

		{
			...
			Matrix<double> R(4, 4);
			int status = QR(testMatrix, Q, R);
			cout << "R = " << endl << R << endl << "Q = " << endl << Q << endl;
			Matrix<double> QR = Q * R;
			cout << "QR = " << endl << QR << endl;
		}
...

		{
			...
			Matrix<double> testMatrix(10, 10, simpleData);
			cout << testMatrix << endl << "Computing QR decomposition..." << endl;
			Matrix<double> Q(10, 10);
...

		{
			...
			Matrix<float> testMatrix(10, 10, simpleData);
			cout << testMatrix << endl << "Computing QR decomposition..." << endl;
			Matrix<float> Q(10, 10);
			Matrix<float> R(10, 10);
			int status = QR(testMatrix, Q, R);
			cout << "R = " << endl << R << endl << "Q = " << endl << Q << endl;
			Matrix<float> QR = Q * R;
			cout << "QR = " << endl << QR << endl;
